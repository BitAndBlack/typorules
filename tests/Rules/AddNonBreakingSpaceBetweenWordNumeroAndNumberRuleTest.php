...
final class AddNonBreakingSpaceBetweenWordNumeroAndNumberRuleTest extends AbstractRuleTestClass
{
    ...
    public static function getTestRuleData(): Generator
    {
        yield [
            'C\'est le n° 8.',
            'C\'est le n°' . CharactersEnum::NON_BREAKING_SPACE_THIN_UTF8->value . '8.',
            'C\'est le n° 8.',
        ];

        yield [
            'N° 8.',
            'N°' . CharactersEnum::NON_BREAKING_SPACE_THIN_UTF8->value . '8.',
            'N° 8.',
        ];
        ...
        yield [
            'Numéro 8.',
            'Numéro' . CharactersEnum::NON_BREAKING_SPACE_THIN_UTF8->value . '8.',
            'Numéro 8.',
        ];
