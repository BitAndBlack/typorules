...
final class AddSpaceBetweenBracketsRuleTest extends AbstractRuleTestClass
{
    ...
    public static function getTestRuleData(): Generator
    {
        yield [
            ...
            'a' . CharactersEnum::NON_BREAKING_HAIR_SPACE_UTF8->value . ') Es geht los (' . CharactersEnum::NON_BREAKING_HAIR_SPACE_UTF8->value . 'warum auch immer' . CharactersEnum::NON_BREAKING_HAIR_SPACE_UTF8->value . ')! Was(' . CharactersEnum::NON_BREAKING_HAIR_SPACE_UTF8->value . 'es' . CharactersEnum::NON_BREAKING_HAIR_SPACE_UTF8->value . ')wir es?',
            'a) Es geht los (warum au...',
        ];

        yield [
            '(Einfach nein.)',
            '(' . CharactersEnum::NON_BREAKING_HAIR_SPACE_UTF8->value . 'Einfach nein.)',
            '(Einfach nein.)',
        ];
