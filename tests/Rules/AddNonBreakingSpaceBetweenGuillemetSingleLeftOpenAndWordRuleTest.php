...
final class AddNonBreakingSpaceBetweenGuillemetSingleLeftOpenAndWordRuleTest extends AbstractRuleTestClass
{
    ...
    public static function getTestRuleData(): Generator
    {
        yield [
            ...
            'Je t\'ai dit « non », car « tout à l\'heure, tu m\'as dit ‹' . CharactersEnum::NON_BREAKING_SPACE_THIN_UTF8->value . 'oui › ».',
            '... dit ‹ oui › »....',
        ];
