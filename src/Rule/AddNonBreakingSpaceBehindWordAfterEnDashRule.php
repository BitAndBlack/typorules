...
/**
 * @see \BitAndBlack\TypoRules\Tests\Rules\AddNonBreakingSpaceBehindWordAfterEnDashRuleTest
 */
#[Description(
...
class AddNonBreakingSpaceBehindWordAfterEnDashRule extends AbstractRule implements RuleInterface
{
