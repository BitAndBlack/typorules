 ...
 * @deprecated This class has been renamed. Please use {@see AddNonBreakingSpaceBehindWordAfterColonRule} instead.
 * @see AddNonBreakingSpaceBehindWordAfterColonRule
 * @todo Remove in v1.0.
 */
#[Description(
...
class BindWordAfterColonRule extends AddNonBreakingSpaceBehindWordAfterColonRule implements RuleInterface
{
}
