 ...
 * @deprecated This class has been renamed. Please use {@see AddNonBreakingSpaceBehindWordAfterSemicolonRule} instead.
 * @see AddNonBreakingSpaceBehindWordAfterSemicolonRule
 * @todo Remove in v1.0.
 */
#[Description(
...
class BindWordAfterSemicolonRule extends AddNonBreakingSpaceBehindWordAfterSemicolonRule implements RuleInterface
{
}
