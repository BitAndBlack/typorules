...
/**
 * @see \BitAndBlack\TypoRules\Tests\Rules\AddNonBreakingSpaceBehindWordAfterSemicolonRuleTest
 */
#[Description(
...
class AddNonBreakingSpaceBehindWordAfterSemicolonRule extends AbstractRule implements RuleInterface
{
    ...
    #[Configuration('Configure the minimum length for the word after the semicolon. It needs to have a length of at least `3` characters per default.')]
    ...
    #[Configuration('Configure the maximum length for the **second** word after the semicolon. By default, it must not have more than `5` characters.')]
