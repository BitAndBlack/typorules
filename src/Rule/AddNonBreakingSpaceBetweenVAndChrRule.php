...
/**
 * @see \BitAndBlack\TypoRules\Tests\Rules\AddNonBreakingSpaceBetweenVAndChrRuleTest
 */
#[Description(
    'Add a thin non-breaking space between the words `v.` and `Chr.` to disallow separating them from each other. '
