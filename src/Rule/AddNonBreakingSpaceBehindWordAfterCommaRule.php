...
/**
 * @see \BitAndBlack\TypoRules\Tests\Rules\AddNonBreakingSpaceBehindWordAfterCommaRuleTest
 */
#[Description(
...
class AddNonBreakingSpaceBehindWordAfterCommaRule extends AbstractRule implements RuleInterface
{
